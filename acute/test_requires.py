...
import config
library_name = config.driver_name
if __name__ == '__main__':
    library_name = 'self_test'
...
class SupportedFeatures(object): 
    ...
    def __init__(self, library_name): 
        ...
        """ 
        if library_name == 'self_test': 
            self.typical_feature = True
        if library_name == 'pysqlite2':
            ...
            #self.callproc = False
        elif library_name == 'psycopg2':
            self.serial_key_def = 'serial'
        elif library_name == 'pydb2':
