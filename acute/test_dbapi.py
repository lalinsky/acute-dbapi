...
#from nose_plugins import requires
...
#requires.set_supported_features(driver_supports)
set_supported_features(driver_supports)

#-- Start of code moved to features.py
...
#
#dbapi_level = "2.0"
#--- End of code moved to features.py
...
class TestModule(Base):
    ...
    #@requires.requires('driver_level_datatypes')
...
class TestTypesEmbedded(Base):
    ...
    #TODO: Write tests for rowid.  This used to rely on rowid, but psycopg2 doesn't support it
